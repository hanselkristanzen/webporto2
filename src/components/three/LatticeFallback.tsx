/**
 * A frozen, hand-composed echo of the interactive lattice. Rendered instead
 * of the WebGL scene when the visitor prefers reduced motion, or when
 * WebGL isn't available — no animation, no pointer tracking, just the same
 * visual language at rest.
 */
